...
<head>
    ...
    <title><?= html_escape($cafe->cafe_name) ?> - OLONA</title>
...
<body class="bg-slate-50 pb-24 text-slate-800">
    ...
    <script>
        async function shareCafe() {
            ...
            const shareData = {
                title: <?= json_encode($cafe->cafe_name . ' - OLONA') ?>,
                text: <?= json_encode('Lihat menu dan reservasi di ' . $cafe->cafe_name . ' melalui OLONA:') ?>,
                url: shareUrl
            };
